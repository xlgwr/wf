...
{
    public partial class Sys_InProcess_Sub : PageBase
    {
        ...
        {
            gridData.DataSource = new Sys_Form_Mstr().GetModelList("form_seq > 0 and form_type ='CV' and charindex('"+ReqNbr+"',form_nbr)>0  order by form_nbr");//and form_location = '"+strLocation+"'
        ...
        protected void gridData_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                string Nbr = gridData.DataKeys[e.Row.RowIndex]["form_nbr"].ToString();
                string Seq = gridData.DataKeys[e.Row.RowIndex]["form_seq"].ToString().Trim();
