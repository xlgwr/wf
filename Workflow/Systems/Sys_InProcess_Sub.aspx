<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sys_InProcess_Sub.aspx.cs" Inherits="Workflow.Systems.Sys_InProcess_Sub" Theme="GridView" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
  <title>Sub Forms In Process / 处理中的表单</title>
...
<body>
    ...
    <div class="subHeader">
        <div>
            <asp:Label ID="lblTitle" runat="server" Text="Sub Forms In Process" ToolTip="处 理 中 的 子 表 单"></asp:Label>：
            <asp:Label ID="lblNbr" runat="server" Text="" ToolTip=""></asp:Label>
        </div>
    </div>
    <asp:GridView ID="gridData" runat="server" SkinID="GridView" Width="100%" 
          ...
          <EmptyDataTemplate>
                                    <div class="emptydatatemplate">
                                        <asp:Label ID="lblNoData1" runat="server" Text="No sub detail record" ToolTip="没有子信息"></asp:Label>
                                    </div>
                                </EmptyDataTemplate>
     <Columns>
        <asp:TemplateField HeaderText="Number" FooterText="单号" ItemStyle-Width="10%">
                <ItemTemplate>
