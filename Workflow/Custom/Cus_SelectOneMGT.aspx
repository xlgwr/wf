<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cus_SelectOneMGT.aspx.cs" Inherits="Workflow.Custom.Cus_SelectOneMGT" %>
   ...
   <title>Select User / 选择用户</title>
    ...
    <script language="javascript" type="text/javascript">
        function oneuser() {
            ...
            var txtid = $("#txtctrlname").val();
            fWindowText1 = window.opener.document.getElementById(txtid);
