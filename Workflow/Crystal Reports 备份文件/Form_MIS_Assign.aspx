...
<body>
    ...
    <div style="width: 80%">
      ...
      <asp:Panel runat="server" ID="Panel1">
                ...
                <td bgcolor="EAF2F9">
                    <div align="right">
                        <asp:Label ID="lblCompany" runat="server" Text="Company" ToolTip="公 司"></asp:Label>:</div>
                </td>
                <td>
            ...
            <tr bgcolor="#FFFFFF" class="tr_assign">
                <td bgcolor="EAF2F9">
                    <div align="right">
                        <asp:Label ID="Label3" runat="server" Text="Assign To" ToolTip="分 配"></asp:Label>:</div>
                </td>
                <td>
                    <asp:DropDownList ID="dropGroup" runat="server" Visible="false">
                    </asp:DropDownList>
            ...
            <tr bgcolor="#FFFFFF" class="tr_assign">
                <td bgcolor="EAF2F9">
                    <div align="right">
                        <asp:Label ID="lblPlanEnd" runat="server" Text="Plan End" ToolTip="计划结束日期"></asp:Label>:</div>
                </td>
                <td>
