<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form_MIS_Complete.aspx.cs"
    ...
    <div style="width: 80%">
        <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="3A66AD" style="table-layout: fixed">
            ...
            <tr bgcolor="#FFFFFF">
                ...
                <td>
                    <asp:TextBox ID="txtPlanBegin" runat="server" CssClass="myLineFill" Enabled="true"
                        ReadOnly="True"></asp:TextBox>
                </td>
                <td bgcolor="EAF2F9">
                    <div align="right">
                ...
                <td colspan="2">
                    <asp:TextBox ID="txtPlanEnd" runat="server" CssClass="myLineFill" Enabled="true"
                        ReadOnly="True"></asp:TextBox>
                </td>
            </tr>
            <tr bgcolor="#FFFFFF">
                ...
                <td colspan="2">
                    <asp:TextBox ID="txtActEnd" runat="server" CssClass="textdate"></asp:TextBox>
                </td>
            </tr>
            <tr bgcolor="#FFFFFF">
                <td bgcolor="EAF2F9">
