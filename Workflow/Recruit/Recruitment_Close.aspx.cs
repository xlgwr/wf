...
{
    public partial class Recruitment_Close : PageBase
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            Cus_Job_Det_Model jobDetModel = jobDet.GetModel(cv_guid);
            Cus_Job_Det_Model cvModel = new Cus_Job_Det_Model();
            actonboard = Request.Form["txtActualDate"].Trim();
            endProbation = Request.Form["txtEndDate"].Trim();
            if (actonboard == "")
            {
                Show(Page, "Please enter on board date", "请输入到班日期", strLang);
                return;
            ...
            cvModel.cv_onboard_date = DateTime.Parse(actonboard);
            cvModel.cv_probation_end_date = DateTime.Parse(endProbation);
