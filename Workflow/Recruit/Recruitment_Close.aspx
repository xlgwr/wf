<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Recruitment_Close.aspx.cs" Inherits="Workflow.Recruit.Recruitment_Close" Theme="GridView" %>
            ...
            <fieldset>
                ...
                <div style="float: left; width: 50%">
                    <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="" style="height: 200px">
                        ...
                        <tr bgcolor="">
                            ...
                            <td colspan="2">
                                <asp:TextBox ID="txtActualDate" runat="server" CssClass="textdate" ReadOnly="true"></asp:TextBox>
                        ...
                        <tr bgcolor="">
                            ...
                            <td colspan="2">
                                <asp:TextBox ID="txtEndDate" runat="server" CssClass="textdate" ReadOnly="true"></asp:TextBox>
                ...
                <div id="div_ATTACH" runat="server" visible="false" style="clear: both">
                    <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="3A66AD" style="table-layout: fixed">
                        ...
                        <tr class="attachment_head">
                            <td>
                                <asp:Label ID="Label14" runat="server" Text="Add Reference" ToolTip="增加参照"></asp:Label>:
                            </td>
                        </tr>
                        <tr bgcolor="#FFFFFF">
                            <td align="left">
