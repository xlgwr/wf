<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Recruitment_Confirm.aspx.cs" Inherits="Workflow.Recruit.Recruitment_Confirm" Theme="GridView" %>
            ...
            <fieldset>
                        ...
                        <tr bgcolor="">
                            <td bgcolor="" width="15%">
                                <div align="right">
                                    ...
                                    <asp:Label ID="Label9" runat="server" Text="Commits On Board Date" ToolTip="上班日期"></asp:Label>:
                                </div>
                            </td>
                            <td colspan="2">
                                <asp:TextBox ID="txtOnboardDate" runat="server" CssClass="textdate" ReadOnly="true"></asp:TextBox>
                            </td>
                        </tr>
                        <tr bgcolor="">
                            <td bgcolor="" width="15%">
                ...
                <div id="div_ATTACH" runat="server" visible="false" style="clear:both">
                    <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="3A66AD" style="table-layout: fixed">
                        ...
                        <tr class="attachment_head">
                <td >
                    <asp:Label ID="Label12" runat="server" Text="Add Reference" ToolTip="增加参照"></asp:Label>:
                </td>
            </tr>
            <tr bgcolor="#FFFFFF">
                <td align="left">
