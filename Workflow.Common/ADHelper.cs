...
namespace Workflow.Common
{
    public class ADHelper
    {
         ...
         ///域名
         ///
        private static string DomainName = "wongswtsz";
         ///
         /// LDAP 地址
         ///
         ...
         /// LDAP绑定路径
         ///
         public  static string ADPath = "LDAP://OU=wtszuser,DC=wongswtsz,DC=com";
         ///
         ///登录帐号
         ///
         private static string ADUser = "MIS.APP@wongswtsz.com";
         ///
         ///登录密码
         ///
         private static string ADPassword = "GYKI007!";
         ///
         ///扮演类实例
         ///
