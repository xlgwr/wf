...
namespace Workflow.AD.Operate
{
    public class ADHelper
    {
        ...
        /// 域名
        /// </summary>
        private static string DomainName = "wongswtsz.com";
        /// <summary>
        /// LDAP 地址
        /// </summary>
        private static string LDAPDomain = "DC=wongswtsz,DC=com";
        /// <summary>
        /// LDAP绑定路径
        /// </summary>
        private static string ADPath = "LDAP://10.10.11.208/OU=wtszuser,DC=wongswtsz,DC=com";//
        private static string sPrincpleNameTail = "@cinf.com";
        /// <summary>
        /// 登录帐号
        /// </summary>
        private static string ADUser = "admin.oa@wongswtsz.com";
        /// <summary>
        /// 登录密码
        /// </summary>
        private static string ADPassword = "Park8101";
